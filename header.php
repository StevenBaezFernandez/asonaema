...
<div class="panel_busqueda">
    ...
    <div class="buscador">
        <div class="header_buscador">
            <h2 class="title_buscador">Panel de busqueda</h2>        
        </div>
        <img src="http://localhost/asonaema/img/cancel.svg" class="cerrar_buscador" alt="">
        <div class="input_group_buscador">
            <i class="fas fa-search"></i>
            <input type="text"  placeholder="Buscar productos" class="cuadro_busqueda" id="cuadro_busqueda" autocomplete="off">
        </div>
